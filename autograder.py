...
if __name__ == '__main__':
    ...
    print("Training on training.txt, running tests on autotest.txt. "
          "Output --> autooutput.txt")
    os.system("python3 tagger.py -d training7.txt training2.txt training3.txt training5.txt -t test8.txt -o autooutput.txt")
